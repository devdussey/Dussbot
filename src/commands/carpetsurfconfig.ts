...
const carpetSurfConfigStore = requireFromSrcIfNeeded('../utils/carpetSurfConfigStore');
const carpetSurfManager = requireFromSrcIfNeeded('../utils/carpetSurfManager');
      ...
      sub
        ...
        .addIntegerOption((option) =>
          option
            ...
            .setMinValue(1)
            .setMaxValue(1440)))
    .addSubcommand((sub) => sub.setName('disable').setDescription('Disable periodic CarpetSurf rounds'))
    .addSubcommand((sub) => sub.setName('status').setDescription('View CarpetSurf configuration and asset counts'))
    .addSubcommand((sub) => sub.setName('run').setDescription('Run a CarpetSurf round now')),

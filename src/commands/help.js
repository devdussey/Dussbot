...
const categories = {
  ...
  'Moderation & Enforcement': [
    ...
    { cmd: '/unban', desc: 'Lift a ban using an audit reason', perm: 'Ban Members' },

    { cmd: '/unmute', desc: 'Remove a timeout with a required reason', perm: 'Moderate Members' },

    { cmd: '/modconfig', desc: 'Assign the moderator role and log channel for the moderation commands', perm: 'Manage Server' },
  ...
  'Server Setup & Messaging': [
    ...
    { cmd: '/sacrificeconfig', desc: 'Post an anonymous user-nomination menu for communal sacrifice', perm: 'Administrator' },
